<template>
    <div class="bg-kubgtu-white py-12 px-6 shadow-lg rounded-xl border border-border-light text-center">
        <div class="mb-8">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-red-500 to-red-600 rounded-full mb-6 shadow-xl">
            ...
            <p class="text-gray-600 max-w-md mx-auto mb-8">
                У вас нет прав для доступа к этому ресурсу. Если вы считаете, что это ошибка, обратитесь к администратору.
            </p>
        </div>
...
// Layout применяется через defineOptions, не нужно оборачивать в шаблоне
