    ...
    <div class="bg-kubgtu-white py-12 px-6 shadow-lg rounded-xl border border-border-light text-center">
        <div class="mb-8">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-orange-500 to-red-600 rounded-full mb-6 shadow-xl">
                <i class="pi pi-exclamation-triangle text-6xl text-white"></i>
            </div>
            ...
            <p class="text-gray-600 max-w-md mx-auto mb-8">
                Произошла непредвиденная ошибка на сервере. Мы уже работаем над её устранением. Пожалуйста, попробуйте позже.
            </p>
        </div>
