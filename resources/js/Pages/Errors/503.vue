<template>
    <div class="bg-kubgtu-white py-12 px-6 shadow-lg rounded-xl border border-border-light text-center">
        <div class="mb-8">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-full mb-6 shadow-xl">
                <i class="pi pi-clock text-6xl text-white"></i>
            </div>
            ...
            <p class="text-gray-600 max-w-md mx-auto mb-8">
                Сервис временно недоступен из-за технического обслуживания. Мы вернёмся в ближайшее время.
            </p>
        </div>
