...
@section('title', 'Добро пожаловать в Klust')

@section('content')
    <h2>Добро пожаловать, {{ $user->name }}!</h2>

    <p>Рады приветствовать вас на платформе <strong>Klust</strong> – образовательной платформе для работы над реальными кейсами от компаний-партнеров.</p>
    ...
    <ul>
        ...
        <li>Развивать свои навыки и получать бейджи</li>
