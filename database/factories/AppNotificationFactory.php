...
class AppNotificationFactory extends Factory
{
    public function definition(): array
    {
        ...
        $messages = [
            ...
            'badge' => [
                'Поздравляем! Вы получили новое достижение. Проверьте свой профиль для просмотра достижения.',
                'Отличная работа! Вам присвоено новое достижение за ваши успехи. Продолжайте в том же духе!',
                'Новое достижение добавлено в вашу коллекцию. Откройте профиль, чтобы увидеть детали.',
            ],
            'system' => [
